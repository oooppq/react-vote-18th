...
const AuthorizedInfo = ({
  ...
  return (
    <>
      <span className="mr-2 bg-ceos-1 text-white rounded-[20px] text-xs md:text-xl px-5 py-2.5 box-border justify-center items-center inline-flex">{`${userInfo.teamName} ${userInfo.part} ${userInfo.name}`}</span>
      <NavButton
